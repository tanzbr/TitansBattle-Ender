...
public class DiscordAnnounces {
    ...
    public static void announceEnded(String name, String winnerName, int winnerPoints, int winnerPlayersCount,
            int winnerKillsCount, int winnerKillsPoints, String secondPlaceName, int secondPlacePoints,
            int secondPlacePlayersCount, int secondPlaceKillsCount, int secondPlaceKillsPoints, String thirdPlaceName,
            int thirdPlacePoints, int thirdPlacePlayersCount, int thirdPlaceKillsCount, int thirdPlaceKillsPoints,
            long duration, String killerName, int killerKillsCount, java.io.File logFile) {
        if (DiscordBot.eventChannel == null) {
            return; // Discord bot not initialized, skip announcement
        }

        MessageCreateAction messageAction = DiscordBot.eventChannel
                .sendMessage("<@&1455703005080060189>")
                .addEmbeds(DiscordEmbeds.getEndedEmbed(name, winnerName, winnerPoints, winnerPlayersCount,
                        winnerKillsCount, winnerKillsPoints, secondPlaceName, secondPlacePoints,
